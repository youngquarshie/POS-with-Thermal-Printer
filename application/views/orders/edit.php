              ...
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Enter Customer Name" value="<?php echo $order_data['order']['order_type'] ?>" readonly autocomplete="off"/>
                    </div>
                  </div>


                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Order Table</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $order_data['order']['order_table'] ?>" readonly autocomplete="off">
                    </div>
                  </div>
                </div>
                   ...
                   '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                        ...
                        $.each(response, function(index, value) {
                          html += '<option value="'+value.p_id+'">'+value.name+' '+''+value.variation_name+'</option>';             
                        });
