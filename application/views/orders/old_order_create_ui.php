              ...
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select_group product" id="order_type" name="order_type" style="width:100%;" required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select_group product"  id="tables" name="order_table" style="width:100%;"  required>
                            <option value=""></option>
