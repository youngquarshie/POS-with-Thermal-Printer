    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('tables/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Table Name</label>
            <input type="text" class="form-control" id="edit_table_name" name="edit_table_name"  autocomplete="off">
          </div>
          <div class="form-group">
