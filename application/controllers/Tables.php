...
class Tables extends Admin_Controller 
{
	...
	/* 
	* It only redirects to the manage Table page
	*/
	public function index()
	{
		...
		$this->render_template('vault-tables/index', $this->data);	
	}	
	...
	*/
	public function fetchTableDataById($id) 
	{
		if($id) {
	...
	public function update($id)
	{
		...
		if($id) {
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	...
	        	$update = $this->model_tables->update($data, $id);
	        	if($update == true) {
	        		$response['success'] = true;
	...
	*/
	public function remove()
	{
		...
		$response = array();
		if($category_id) {
			$delete = $this->model_tables->remove($category_id);
			if($delete == true) {
				$response['success'] = true;
